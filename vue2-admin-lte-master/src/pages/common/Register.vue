<template>
  <div class="register-container relative">
    ...
    <div class="login-username relative" :class="{'m-b-lg': usernameError}">
    ...
    <div class="m-b-md">
      <el-checkbox v-model="protocol" class="m-r-sm ipt-protocol"></el-checkbox>我已经阅读并接受 <span @click="protocolShow = true" class="text-blue1 cursor-p">新光院线绑定应用协议</span>
    </div>
