    ...
    <div class="page-container">
      <div class="page-toolbar clear">
        <div class="pull-left toolbar-candle">
          <a href="javascript:;" class="app-add btn bg-blue1 text-white"><i class="fa fa-plus-square"></i>添加</a>
        ...
        <div class="pull-right clear">
          ...
          <div class="pull-left m-r-sm" style="height: 40px;line-height:40px;">至</div>
          <div class="pull-left m-r-sm relative">
            <el-date-picker
              v-model="calendarVal"
              type="date"
          ...
          <div class="pull-left m-r-sm"><selection :list="iptList" v-model="status" style="width:120px;"></selection></div>
<!--           <div class="pull-left m-r-sm btn app-calendar relative">
      ...
      <div class="app-content-container">
        <ul>
          <li class="col-lg-1 col-md-1 col-sm-1 col-xs-1 clear app-first-item text-center">ID</li>
          <li class="col-lg-2 col-md-2 col-sm-2 col-xs-2 app-name text-center">应用名称</li>
          <li class="col-lg-3 col-md-3 col-sm-3 col-xs-3 app-type text-center">电影名称</li>
          <li class="col-lg-2 col-md-2 col-sm-2 col-xs-2 app-status text-center">收入</li>
          <li class="col-lg-1 col-md-1 col-sm-1 col-xs-1 app-time text-center">购买数量</li>
          <li class="col-lg-1 col-md-1 col-sm-1 col-xs-1 app-remark p-o-sm">分成比例</li>
          <li class="col-lg-2 col-md-2 col-sm-2 col-xs-2 app-candle text-center">时间</li>
        </ul>
        <ul v-for="item in data.rows">
          <li class="col-lg-1 col-lg-1 col-sm-1 col-xs-1 clear app-first-item text-center">{{item.id}}</li>
          <li class="col-lg-2 col-md-2 col-sm-2 col-xs-2 app-name text-center">{{item.webname}}</li>
          <li class="col-lg-3 col-md-3 col-sm-3 col-xs-3 app-type text-center"></li>
          <li class="col-lg-2 col-md-2 col-sm-2 col-xs-2 app-status text-center" :class="{'text-orange': item.audit_status=='未审核', 'text-green': item.audit_status=='已通过', 'text-red': item.audit_status=='未通过'}"></li>
          <li class="col-lg-1 col-md-1 col-sm-1 col-xs-1 app-time text-center"></li>
          <li class="col-lg-1 col-md-1 col-sm-1 col-xs-1 app-remark p-o-sm"></li>
          <li class="col-lg-2 col-md-2 col-sm-2 col-xs-2 app-candle text-center"></li>
        </ul>
      </div>
